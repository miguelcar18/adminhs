...
@section('titulo')
    <title>Nuevo usuario | Hispanos Soluciones</title>
@stop
...
@section('contenido')
    ...
    @endif
    @include('layouts.breadcrumb', ['titulo' => 'Usuarios ', 'subtitulo' => 'Nuevo'])
            ...
            <div class="col-xs-12">
                <div class="box box-success">
                    <div class="box-body">
                        ...
                        [[ Form::open(array('route' => 'users.store', 'method' => 'post', 'class' => 'form-horizontal', 'files' => true, 'id' => 'form_user')) ]]
